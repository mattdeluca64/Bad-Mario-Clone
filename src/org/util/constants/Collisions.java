...
public class Collisions{
	...
	CATEGORYBIT_FOOT + CATEGORYBIT_HEAD + CATEGORYBIT_WALL+ CATEGORYBIT_BOTTOM + CATEGORYBIT_PLAYER+ CATEGORYBIT_GROUND;
	public static final short MASKBITS_GROUND =
	CATEGORYBIT_FOOT + CATEGORYBIT_HEAD + CATEGORYBIT_WALL+ CATEGORYBIT_BOTTOM + CATEGORYBIT_PLAYER+ CATEGORYBIT_GROUND;
	//---------------------------
	public static final short MASKBITS_BOTTOM = CATEGORYBIT_WALL+CATEGORYBIT_GROUND+CATEGORYBIT_BOTTOM+CATEGORYBIT_HEAD;
	//---------------------------
	public static final short MASKBITS_PLAYER = CATEGORYBIT_WALL+ CATEGORYBIT_PLAYER+ CATEGORYBIT_GROUND+ CATEGORYBIT_BOTTOM;
	public static final short MASKBITS_HEAD = CATEGORYBIT_BOTTOM;
	public static final short MASKBITS_FOOT = CATEGORYBIT_GROUND + CATEGORYBIT_WALL;
